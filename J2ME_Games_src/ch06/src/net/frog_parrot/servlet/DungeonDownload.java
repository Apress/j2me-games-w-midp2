...
public class DungeonDownload extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
	...
	response.setContentLength(0);
      ...
      System.err.println("DungeonDownload.doPost-->caught " + eofe.getClass()
			 + ": " + eofe.getMessage());
      eofe.printStackTrace();
      response.sendError(408, eofe.getMessage());
    } catch(IOException ioe) {
      System.err.println("DungeonDownload.doPost-->caught " + ioe.getClass()
			 + ": " + ioe.getMessage());
      ioe.printStackTrace();
      response.sendError(500, ioe.getClass() + ": " + ioe.getMessage());
    } catch(Exception e) {
      System.err.println("DungeonDownload.doPost-->caught " + e.getClass()
			 + ": " + e.getMessage());
      e.printStackTrace();
